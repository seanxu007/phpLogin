<?php
session_start();
include('module/hybridauth-master/hybridauth/config.php');
include('module/hybridauth-master/hybridauth/Hybrid/Auth.php');
...
try{
    ...
    if($user_profile && isset($user_profile->identifier))
    {
        ...
        social_login($user_profile,$_GET['provider'],$mysqli);
